...
public class Ticket {
	//Plantilla para crear un objeto de respuesta a 
	//las operaciones del cajero
	
	//Es decir, sí la operación se realiza de forma exitosa
	//Devolvera el ticket de operación
