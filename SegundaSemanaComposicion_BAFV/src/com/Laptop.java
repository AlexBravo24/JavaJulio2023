...
public class Laptop {//Es un objeto que puede tener de atributos a otros objetos

	private String marca;
	private String color;
	
	private Almacenamiento disco; // este es un objeto en la realidad con atributos propios
