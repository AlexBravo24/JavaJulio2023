...
public class Ticket {
	//Plantilla para crear un objeto de respuesta, a las operaciobes que realzará nuestro cajero
	// Es decir, si la operacion se realiza exitosamente se nos dvolverá el valor de un ticket
	// de opeación
	
	// Atribuos de unticket
