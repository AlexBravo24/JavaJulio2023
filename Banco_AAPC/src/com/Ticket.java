...
public class Ticket {
//Plantilla para crear un objeto de respuesta a las operaciones que realizara 
//	nuestro cajero, si la operacion se realiza exitosamente 
//	se nos devolvera el valor de un ticket de operacion
