...
public class Ticket {
	//Plantilla para crear un objeto de respuesta 
	//a las operaciones que realizara nuestro cajero
	//Es decir, si la operacion se realiza exitosamente
	//se nos devolvera el valor de un ticket de 
	//operacion
	...
	public Ticket(int folioOperacion, Date fechaHora, String usuario, double saldo, String sucursal, String idCajero) {
		super();
