...
public class Empleado extends Persona{
	...
	//Generamos el constructor con todos los parámetros
	// Y seleccionamos también el constructor de la clase padre (Persona)
	// para poder heredarlos y utilizarlos al instanciar a un nuevo empleado
