...
public class Ticket {
	...
	//Plantilla para crear un objeto de respuesta a las operaciones que realizara el cajero
	//Es decir si la operacion se realiza existosamente se nos devolvera el valor de un ticket de operacion
